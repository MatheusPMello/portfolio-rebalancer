            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <select 
                  ...
                  value={currency} onChange={e => setCurrency(e.target.value as 'USD' | 'BRL')}
                >
              ...
              <div className="mb-3">
                ...
                <input 
                  ...
                  value={targetPercentage} onChange={e => setTargetPercentage(e.target.value)} required 
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <input 
                  type="number" step="0.01" className="form-control" 
                  value={currentValue} onChange={e => setCurrentValue(e.target.value)} required 
                />
              </div>
