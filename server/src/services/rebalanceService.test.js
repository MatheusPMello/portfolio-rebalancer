...
describe('Rebalance Service Logic', () => {
  ...
  test('should correct an underweight asset', () => {
    ...
    const assets = [
      ...
      { id: 1, name: 'Safe Asset', current_value: 5000, target_percentage: 50, currency: 'BRL' },
      // Asset B is empty (50% target, has 0) -> It needs money!
      { id: 2, name: 'Risky Asset', current_value: 0, target_percentage: 50, currency: 'BRL' }
    ];
  ...
  test('should handle USD assets correctly', () => {
    ...
    const assets = [
      ...
      { id: 1, name: 'Apple Stock', current_value: 0, target_percentage: 100, currency: 'USD' }
    ];
